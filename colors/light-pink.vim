...
let s:highlights = [
      ...
      \ { 'group': 'PmenuSel'     ,'fg': ''           ,'bg': s:Colors[10] ,'style': 'NONE' },
      ...
      \ { 'group': 'Visual'       ,'fg': 'NONE'       ,'bg': s:Colors[15]  ,'style': '' },
      \ { 'group': 'DiffDelete'   ,'fg': s:Colors[18] ,'bg': ''           ,'style': '' },
      \ { 'group': 'DiffChange'   ,'fg': s:Colors[19] ,'bg': ''           ,'style': '' },
      \ { 'group': 'DiffAdd'      ,'fg': s:Colors[20] ,'bg': ''           ,'style': '' },
      \ { 'group': 'MatchParen'   ,'fg': ''           ,'bg': s:Colors[21] ,'style': '' },
      \ { 'group': 'ErrorMsg'     ,'fg': 'Red'        ,'bg': s:Colors[9]  ,'style': '' },
      \ { 'group': 'Delimiter'    ,'fg': s:Colors[20] ,'bg': ''           ,'style': '' },
      \ ]
